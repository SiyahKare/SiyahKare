    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="home">Anasayfa</a></span> <span>Blog</span></p>
...
<div class="card-body">
<h6 class="card-category text-info">{{ trim(\Backpack\NewsCRUD\app\Models\Category::all()->keyBy($article->category_id)->pluck('name')->flatten(),'[]') }}</h6>
<h4 class="card-title">
