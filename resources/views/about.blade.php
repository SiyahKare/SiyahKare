    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.html">Anasayfa</a></span> <span>Hakkımızda</span></p>
      ...
      <section class="ftco-section-featured ftco-section-featured-2 ftco-animate">
        <div class="container-fluid" data-scrollax-parent="true">
          <div class="row mt-5 d-flex justify-content-center">
            ...
            <h2 class="h1"> <strong style="color: black;">SiyahKare Dijital Çözümler</strong></h2>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
                <a href="portfolio" class="image" style="background-image: url('images/vizyon.svg'); " data-scrollax=" properties: { translateY: '-20%'}">
                </a>
                <div class="text">
